...
//			}
	...
	public void addHandlers() {
		...
		actionsMap.addHandler(ACTION_OPTIMIZE_PROJECT, new OptimizeProjectAction());
...
//		actionsMap.addHandler(ACTION_ENTERPRISE_RESOURCES, new EnterpriseResourcesAction());
	...
	public class OptimizeProjectAction extends MenuActionsMap.GlobalMenuAction {
		private static final long serialVersionUID = 1L;
		public void actionPerformed(ActionEvent arg0) {
			setMeAsLastGraphicManager();
			if (isDocumentActive())
				getCurrentFrame().doOptimizeProjectDialog();
		}
	}
